...
## Raccourcis et Commandes Antigravity IDE
> - **Snippet TODO** : Tape `todo` puis touche `Entrée` pour insérer une nouvelle tâche avec ID horodaté unique `[AAAAMMJJ-HHMM]`.
